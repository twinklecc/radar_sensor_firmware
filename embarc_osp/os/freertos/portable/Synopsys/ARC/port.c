...
static void vKernelTick( void *ptr )
{
	...
	timer_int_clear(CHIP_OS_TIMER_ID);
	chip_timer_update(configTICK_RATE_HZ);
...
static void prvSetupTimerInterrupt(void)
{
	...
	int_disable(CHIP_OS_TIMER_INTNO); /* disable os timer interrupt */
	timer_stop(CHIP_OS_TIMER_ID);
	timer_start(CHIP_OS_TIMER_ID, TIMER_CTRL_IE | TIMER_CTRL_NH, cyc);

	int_handler_install(CHIP_OS_TIMER_INTNO, (INT_HANDLER)vKernelTick);
	int_enable(CHIP_OS_TIMER_INTNO);
}
