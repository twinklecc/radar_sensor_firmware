...
###############################################################################
## ALL ##
CSRCS_DIR		= $(CPU_CSRCDIR) $(OS_CSRCDIR) $(DEVHAL_CSRCDIR) $(BOARD_CSRCDIR) $(CHIP_CSRCDIR) \
				$(MID_CSRCDIR) $(LIB_CSRCDIR) $(EXTRA_CSRCDIR) $(CALTERAH_CSRC_DIR) $(APPL_CSRC_DIR)
CXXSRCS_DIR		= $(CPU_CXXSRCDIR) $(OS_CXXSRCDIR) $(DEVHAL_CXXSRCDIR) $(BOARD_CXXSRCDIR) $(CHIP_CXXSRCDIR)\
				$(MID_CXXSRCDIR) $(LIB_CXXSRCDIR) $(EXTRA_CXXSRCDIR) $(CALTERAH_CXXSRC_DIR)\
				$(APPL_CXXSRC_DIR)
ASMSRCS_DIR		= $(CPU_ASMSRCDIR) $(OS_ASMSRCDIR) $(DEVHAL_ASMSRCDIR) $(BOARD_ASMSRCDIR) $(CHIP_ASMSRCDIR)\
				$(MID_ASMSRCDIR) $(LIB_ASMSRCDIR) $(EXTRA_ASMSRCDIR) $(APPL_ASMSRC_DIR)
INCS_DIR		= $(CPU_INCDIR) $(OS_INCDIR) $(DEVHAL_INCDIR) $(BOARD_INCDIR) $(CHIP_INCDIR)\
				$(MID_INCDIR) $(LIB_INCDIR) $(EXTRA_INCDIR) $(CALTERAH_INC_DIR) $(APPL_INC_DIR)
###############################################################################
...
ALL_CSRCS = $(sort $(CPU_CSRCS) $(BOARD_CSRCS) $(LIB_CSRCS) $(MID_CSRCS) $(OS_CSRCS) $(APPL_CSRCS) $(EXTRA_CSRCS) \
		$(CALTERAH_COMMON_CSRC))
ALL_ASMSRCS = $(sort $(CPU_ASMSRCS) $(BOARD_ASMSRCS) $(LIB_ASMSRCS) $(MID_ASMSRCS) $(OS_ASMSRCS) $(APPL_ASMSRCS) \
		$(EXTRA_ASMSRCS) $(CALTERAH_COMMON_ASMSRC))
...
##
ALL_COBJS = $(sort $(CPU_COBJS) $(BOARD_COBJS) $(LIB_COBJS) $(MID_COBJS) $(OS_COBJS) $(APPL_COBJS) $(EXTRA_COBJS) $(CALTERAH_COMMON_COBJS))
ALL_ASMOBJS = $(sort $(CPU_ASMOBJS) $(BOARD_ASMOBJS) $(LIB_ASMOBJS) $(MID_ASMOBJS) $(OS_ASMOBJS) $(APPL_ASMOBJS) $(EXTRA_ASMOBJS) $(CALTERAH_COMMON_ASMOBJS))
