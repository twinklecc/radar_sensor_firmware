...
##
# LOAD XIP TEXT
# For enabling XIP function, "FLASH_XIP" in freertos/sensor/sensor.mk also need to be set to 1
##
LOAD_XIP_TEXT_EN ?= 0
...
COMMON_COMPILE_PREREQUISITES += $(EMBARC_ROOT)/chip/chip.mk
...
include $(EMBARC_ROOT)/chip/chip.mk
...
################# Components from Calterah ###################################
include $(CALTERAH_ROOT)/options/options.mk
